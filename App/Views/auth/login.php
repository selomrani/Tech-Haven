    ...
    <div class="relative w-full max-w-4xl flex flex-col md:flex-row shadow-2xl z-10 animate-fade-in-up">
        ...
        <div class="relative flex flex-col md:flex-row w-full bg-cyber-card rounded-xl overflow-hidden border border-white/10">
            ...
            <div class="w-full md:w-7/12 p-8 md:p-12 relative bg-cyber-dark/95 flex flex-col justify-center">
                ...
                <?php if ($error): ?>
                <div class="flex mb-6 p-3 rounded bg-red-900/20 border-l-4 border-red-500 text-sm relative overflow-hidden animate-fade-in-up">
                    <div class="relative z-10 flex items-center gap-3">
                        <div><i class="fa-solid fa-triangle-exclamation text-red-400"></i></div>
                        <div>
                            <span class="text-red-400 font-bold uppercase text-xs">Error</span><br>
                            <span class="text-gray-400 text-xs"><?php echo htmlspecialchars($error); ?></span>
                        </div>
                    </div>
                </div>
                <?php endif; ?>

                <form id="loginForm" class="space-y-6" action="/signin" method="POST">
                    <div class="space-y-1">
